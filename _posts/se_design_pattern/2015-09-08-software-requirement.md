...
1. 软件的生存周期
	1. 可行性分析和定制开发计划  
	    可行性研究的目的是**使用最小的代价和最短的时间估算软件是否值得开发和能够开发**，主要包括技术可行性、经济可行性和社会可行性。
	2. 需求分析
	3. 总体设计
	4. 详细设计
	5. 编码实现
...
1. 设计模式分为几类？
	...
	2. 结构型模式（6）  
		适配器模式、桥接、组合、装饰、外观、轻量级、代理
	3. 行为型模式（12）  
		责任链、命令、解释器、迭代器、中介者、备忘录、观察者、状态、策略者、模板方法、访问者
...
3. 抽象工厂模式：  
	...
	抽象工厂模式与工厂方法模式的区别就在于**需要创建对象的复杂程度上**。而且抽象工厂模式是[三个](http://blog.csdn.net/ai92/article/details/209198)里面最为抽象、最具一般性的。
...
[【追人与设计模式】](http://bbs.csdn.net/topics/320226682)  
